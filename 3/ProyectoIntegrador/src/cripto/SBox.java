...
/*************************************
* Substitution tables for each S-box *
*************************************/
...
***************/
	...
	private byte table[];	//the substitution table for this s-box
...
* NOTE: the two highest bits of the input byte are irrelevant to this *
*       routine.                                                      *
**********************************************************************/
	...
	//get row number for s-box table
		byte row = (byte)((input & 0x20) | ((input * 16) & 0x10));

	//get column number
		byte col = (byte)((input >>1) & 0x0f);
